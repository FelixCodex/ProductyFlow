...
import {
	createCalendarList,
	createListElement,
} from './functions/tm/creator.js';
import {
	calendarBackwardMove,
	calendarForwardMove,
	editProjectName,
} from './functions/tm/events.js';
import {
	loadProjectsFromUsers,
	createNewProject,
	update,
	createProjectButtons,
} from './functions/tm/requests.js';
import {
	checkLang,
	getCurrentListProject,
	langChange,
	moonset,
	setIsSaveToTrue,
	sunset,
	...
	setDaysToBackward,
	setDaysToForward,
	setActualCalendarPosition,
	logout,
} from './functions/tm/tmUtils.js';
import {
...
window.addEventListener('load', e => {
	...
	calendarSurface.appendChild(
		createCalendarList(convertDateToString(date), date.getMonth(), getLang())
	);
	calendarSurface.appendChild(
		createCalendarList(
